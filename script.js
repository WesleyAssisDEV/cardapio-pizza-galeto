const WHATSAPP_PIZZARIA = "5511993569680";
...
const produtos_db = [
  ...
  },
  {
    ...
    descricao:
      "Molho de tomate, bastante muçarela, rodelas de tomate e orégano.",
    preco: 40.0,
    imagem: "assets/pizza-mussarela.jpg",
  },
  {
    id: 3,
    categoria: "pizzas",
    nome: "Pizza Marguerita",
    descricao: "Molho de tomate, muçarela, tomate, parmesão e manjericão.",
    preco: 42.0,
    imagem: "assets/pizza-marguerita.jpg",
  },
  {
    id: 4,
    categoria: "pizzas",
    nome: "Pizza Portuguesa",
    descricao: "Muçarela, presunto, ovos cozidos, cebola, ervilha.",
    preco: 48.0,
    imagem: "assets/pizza-portuguesa.jpg",
  },
  {
    id: 5,
    categoria: "pizzas",
    nome: "Pizza Frango c/ Catupiry",
    descricao: "Frango desfiado temperado com o verdadeiro Catupiry.",
    preco: 47.0,
    imagem: "assets/pizza-frango-catupiry.jpg",
  },
  {
    id: 6,
    categoria: "pizzas",
    nome: "Pizza Quatro Queijos",
    descricao: "Muçarela, provolone, parmesão e gorgonzola derretidos.",
    preco: 50.0,
    imagem: "assets/pizza-4queijos.jpg",
  },
  {
    id: 7,
    categoria: "pizzas",
    nome: "Pizza Baiana",
    descricao: "Calabresa moída, ovos, pimenta calabresa, cebola.",
    preco: 46.0,
    imagem: "assets/pizza-baiana.jpg",
  },
  {
    id: 8,
    categoria: "pizzas",
    nome: "Pizza Bacon",
    descricao: "Muçarela, fatias de bacon crocante e orégano.",
    preco: 48.0,
    imagem: "assets/pizza-bacon.jpg",
  },
  {
    id: 9,
    categoria: "pizzas",
    nome: "Pizza Peperoni",
    descricao: "Muçarela e fatias de peperoni levemente apimentado.",
    preco: 52.0,
    imagem: "assets/pizza-peperoni.jpg",
  },
  {
    id: 10,
    categoria: "pizzas",
    nome: "Pizza Toscana",
    descricao: "Muçarela, calabresa moída, rodelas de tomate.",
    preco: 45.0,
    imagem: "assets/pizza-toscana.jpg",
  },
  ...
  },
  {
    ...
    descricao: "Refrigerante lata gelado.",
    preco: 6.0,
    imagem: "assets/guarana-lata.jpg",
  },
  {
    id: 106,
    categoria: "bebidas",
...
function toggleCategoria(idCategoria) {
  if (categoriasExpandidas.includes(idCategoria)) {
    ...
    categoriasExpandidas = categoriasExpandidas.filter(
      (cat) => cat !== idCategoria,
    );
...
function renderizarProdutos(filtro = "") {
  ...
  categorias_db.forEach((cat) => {
    const produtosDaCategoria = produtos_db.filter(
      (p) =>
        p.categoria === cat.id &&
    ...
    if (produtosDaCategoria.length > 0) {
      ...
      if (
        !estaBuscando &&
        !isExpandido &&
        produtosDaCategoria.length > limite
      ) {
...
function abrirProduto(id) {
  ...
  document.getElementById("modal-img").onerror = function () {
    this.src =
      "data:image/svg+xml;utf8,<svg xmlns='http://www.w3.org/2000/svg' width='100%' height='200'><rect width='100%' height='200' fill='%232a2a2a'/><text x='50%' y='50%' font-family='Arial' font-size='16' text-anchor='middle' fill='%23666' dy='.3em'>Sem Imagem</text></svg>";
  };
  ...
  document.getElementById("modal-preco").innerText =
    produtoAtualModal.preco > 0
      ? `R$ ${produtoAtualModal.preco.toFixed(2).replace(".", ",")}`
      : "Preço sob consulta";
...
function atualizarPrecoBotaoModal() {
  ...
  if (produtoAtualModal.preco > 0) {
    ...
    document.getElementById("modal-btn-preco").innerText =
...
function atualizarInterfaceCarrinho() {
  ...
  if (qtdTotal > 0) {
    ...
    document.getElementById("bottom-cart-count").innerText =
      `🛒 ${qtdTotal} item(s)`;
    document.getElementById("bottom-cart-total").innerText =
  ...
  document.getElementById("carrinho-subtotal").innerText =
    `R$ ${valorTotal.toFixed(2).replace(".", ",")}`;
}

function alterarItemCarrinho(index, valor) {
  if (carrinho[index].quantidade + valor >= 1)
...
function enviarWhatsApp(event) {
  ...
  if (telefone) textoPedido += `📱 *Contato:* ${telefone}\n`;
  textoPedido += `\n📝 *RESUMO DO PEDIDO:*\n`;
  ...
  // Adicionando o endereço na mensagem
  textoPedido += `📍 *ENDEREÇO DE ENTREGA:*\n`;
  textoPedido += `${rua}, ${numero}\n`;
  textoPedido += `Bairro: ${bairro}\n`;
  if (comp) textoPedido += `Complemento: ${comp}\n`;
